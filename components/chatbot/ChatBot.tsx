...
const BUILT_IN_FAQS: Faq[] = [
  ...
  },
  {
    id: '__bi_8',
    question: '챌린지는 무엇인가요?',
    answer: '🏆 **챌린지**\n\n챌린지는 짧은 기간 동안 진행되는 참여 이벤트입니다.\n\n1. 사이드바에서 **"챌린지"** 메뉴를 클릭하세요.\n2. 진행 중인 챌린지 목록을 확인할 수 있어요.\n3. 참여하려면 챌린지 카드에서 **"참여하기"** 를 클릭하고 내용을 작성하세요.\n4. 다른 참여자들의 제출물도 함께 볼 수 있어요.',
    keywords: ['챌린지', 'challenge', '이벤트', '참여', '참여하기'],
  },
  {
    id: '__bi_9',
